  ...
  const analyzeContract = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://nft-security-analyzer.onrender.com/docs",
        {
          method: "POST",
          body: formData
        }
...
//       trace.includes("[OWNER CHANGE]")

//       ||

//       trace.includes("[TAINT]")
...
//   <div className="legend-pill danger">
//     🔴 Reentrancy
//   </div>

//   <div className="legend-pill external">
//     🟠 External Call
//   </div>

//   <div className="legend-pill blocked">
//     🔵 Blocked Path
//   </div>

//   <div className="legend-pill safe">
//     🟢 Safe Flow
//   </div>
...
//     overflow: "hidden",
//     background:
//       "radial-gradient(circle at top, rgba(15,23,42,0.95), rgba(2,6,23,1))",
//     border:
